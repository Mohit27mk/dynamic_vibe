        ...
        <div className="min-h-screen bg-custom-gradient-2">
          ...
          <div className="relative bg-gradient-to-r from-purple-900 via-blue-900 to-indigo-900 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
              <div className="text-center">
                <h1 className="text-5xl font-bold mb-6">Sailcloth Packages</h1>
                ...
                <div className="inline-block bg-yellow-500 text-gray-900 font-bold px-8 py-4 rounded-lg text-lg hover:bg-yellow-400 transition-colors">
                  Save $$$ On Our Sailcloth Packages!
                </div>
              </div>
            </div>
          ...
          <div className="py-16 bg-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-4xl font-bold text-center mb-12 text-white">Sailcloth Packages</h2>
              <div className="grid md:grid-cols-2 gap-8">
                {[
                  {
                    title: "Up to 50 People – Standard",
                    details: [
                      "32 x 50 Sailcloth Tent",
                  ...
                  },
                  {
                    ...
                    details: [
                      "32 x 70 Sailcloth Tent",
                      "Bistro Lighting Package",
                      "10 – 60″ Round Tables",
                      "3 – 72″ Banquet Table",
                      "80 – White Garden Chairs",
                  ...
                  },
                  {
                    ...
                    details: [
                      ...
                      "10 – 60″ Round Tables",
                      "3 – 72″ Banquet Table",
                      "80 – Chiavari Chairs w/Cushions (Choice of Color)",
                  ...
                  },
                  {
                    ...
                    details: [
                      "44 x 63 Sailcloth Tent",
                      "Bistro Lighting Package",
                      "15 – 60″ Round Tables",
                      "4 – 72″ Banquet Table",
                      "120 – White Garden Chairs w/Padded Seat",
                  ...
                  },
                  {
                    ...
                    details: [
                      "44 x 63 Sailcloth Tent",
                      "Bistro Light Package",
                      "1 Rustic Chandeliers",
                      "15 – 60″ Round Tables",
                      "4 – 72″ Banquet Table",
                      "120 – Chiavari Chairs w/Cushions (Choice of Color)",
                      "18 x 24 Choice of Premium Dance Floor"
                    ]
                  },
                  {
                    title: "Up to 130 People – Standard",
                    details: [
                      "32 x 90 Sailcloth Tent",
                      "Bistro Lighting Package",
                      "16 – 60″ Round Tables",
                      "4 – 72″ Banquet Table",
                      "128 – White Garden Chairs",
                      "20 x 20 Oak Parquet Dance Floor"
                    ]
                  },
                  {
                    title: "Up to 130 People – Premium",
                    details: [
                      "32 x 90 Sailcloth Tent",
                      "Bistro Light Package",
                      ...
                      "16 – 60″ Round Tables",
                      "4 – 72″ Banquet Table",
                      "128 – Chiavari Chairs w/Cushions (Choice of Color)",
                      "18 x 24 Choice of Premium Dance Floor"
                    ]
                  },
                  {
                    title: "Up to 160 People – Standard",
                    details: [
                      "44 x 83 Sailcloth Tent",
                      "Bistro Lighting Package",
                      "20 – 60″ Round Tables",
                      "4 – 72″ Banquet Table",
                      "160 – White Garden Chairs",
                      "20 x 30 Oak Parquet Dance Floor"
                    ]
                  },
                  {
                    title: "Up to 160 People – Premium",
                    details: [
                      "44 x 83 Sailcloth Tent",
                      "Bistro Light Package",
                      "2 Rustic Chandeliers",
                      "20 – 60″ Round Tables",
                      "4 – 72″ Banquet Table",
                      "160 – Chiavari Chairs w/Cushions (Choice of Color)",
                      "18 x 33 Choice of Premium Dance Floor"
                    ]
                  },
                  {
                    title: "Up to 200 People – Standard",
                    details: [
                      "44 x 103 or 57 x 76 Sailcloth Tent",
                      "Bistro Lighting Package",
                      "25 – 60″ Round Tables",
                      "6 – 72″ Banquet Table",
                      "200 – White Garden Chairs",
                      "20 x 36 Oak Parquet Dance Floor"
                    ]
                  },
                  {
                    ...
                    details: [
                      ...
                      "21 x 36 Choice of Premium Dance Floor"
                    ]
                  },
                  {
                    title: "Up to 250 People – Standard",
                    details: [
                      "57 x 96 Sailcloth Tent",
                      "Bistro Lighting Package",
                      "32 – 60″ Round Tables",
                      "6 – 72″ Banquet Table",
                      "250 – White Garden Chairs",
                      "24 x 40 Oak Parquet Dance Floor"
                    ]
                  },
                  {
                    ...
                    details: [
                      ...
                      "24 x 42 Choice of Premium Dance Floor"
                    ]
                  },
                  {
                    title: "Up to 300 People – Standard",
                    details: [
                      "57 x 116 Sailcloth Tent",
                      "Bistro Lighting Package",
                      "38 – 60″ Round Tables",
                      "8 – 72″ Banquet Table",
                      "300 – White Garden Chairs",
                      "34 x 40 Oak Parquet Dance Floor"
                    ]
                  },
                  {
                    title: "Up to 300 People – Premium",
                    details: [
                      "57 x 116 Sailcloth Tent",
                      "Bistro Light Package",
                      ...
                      "38 – 60″ Round Tables",
                      "8 – 72″ Banquet Table",
                      "300 – Chiavari Chairs w/Cushions (Choice of Color)",
                      "33 x 42 Choice of Premium Dance Floor"
                    ]
                  }
                ].map((packageInfo, idx) => (
...
export default SailclothPackages;
